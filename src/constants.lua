...
BOTTOM_EDGE = VIRTUAL_HEIGHT - (VIRTUAL_HEIGHT - MAP_HEIGHT * TILE_SIZE) + MAP_RENDER_OFFSET_Y - TILE_SIZE
RIGHT_EDGE = VIRTUAL_WIDTH - TILE_SIZE * 2
--
-- tile IDs
--
